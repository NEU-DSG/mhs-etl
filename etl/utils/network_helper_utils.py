''' Helper script for creating Graph Object '''
...
def createGraphObject(df_graph, log):
    ''' Function for creating the Graph Object '''
    ...
    eigenvector_dict = nx.eigenvector_centrality(subgraph, tol=1e-03) # Run eigenvector centrality
    ...
    log['num_nodes'] = len(subgraph.nodes)
    log['num_edges'] = len(subgraph.edges)
    return data